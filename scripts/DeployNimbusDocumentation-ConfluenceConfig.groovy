...
//asciidoctor -d book src/Documentation/default.adoc -D build/html5/Documentation
//asciidoctor -d book src/QuickStart/default.adoc -D build/html5/QuickStart
//asciidoctor -d book src/Features/default.adoc -D build/html5/Features
//asciidoctor -d book src/FrameworkOverview/default.adoc -D build/html5/FrameworkOverview
//asciidoctor -d book src/Training/default.adoc -D build/html5/Training

// endpoint of the confluenceAPI (REST) to be used
confluenceAPI = "https://anthemopensource.atlassian.net/wiki/rest/api/"
// the key of the confluence space to write to
confluenceSpaceKey = 'OSS'
...
confluenceCredentials = 'YW50aGVtb3BlbnNvdXJjZUB3ZWJ0ZWtzLmNvbTpEdHQzRUlRTXRVR0RYOGo='
