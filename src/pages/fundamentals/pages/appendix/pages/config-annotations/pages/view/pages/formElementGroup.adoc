...
For example if there is a Name of person that needs to be gather as a user that has a 3 sub fields firstName, middleName and lastName, this can be displayed as a form element group for better user experience.
