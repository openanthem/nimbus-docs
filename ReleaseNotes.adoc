...
** The command executor task palette includes a new attribute for exit condition. This expression determines the criteria to specify if the task can be completed. The framework will not move past beyond the human task unless the criteria evaluates to true
 Attribute name is: Exit Condition
