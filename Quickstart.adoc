...
* Docker - https://docs.docker.com/engine/installation/ (Edge version)
...
change with the other variables through web sockets. Create a file helloworld.drl and place under
src/main/resources/. This file is scanned during the application start up.
