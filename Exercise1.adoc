...
==== Step 8
Rebuild and deploy the web using the script ** sh dev-script-p-dep-all-start-petclinic.sh (Please run this command whenever you make changes to the petclinic configuration project)**
