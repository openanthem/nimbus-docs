...
Please ensure that the below steps are done before the workshop - 

https://confluence.anthem.com/display/NIM/Connect+to+AWS+CLI+to+pull+nimbus+docker+images – Follow this link to be able to access AWS

Windows 10 Troubleshooting and Installation Instructions: 
