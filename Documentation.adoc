...
.Modal Attributes
[width="80%",cols="3,^2,^2,^2,10",options="header"]
|=========================================================
...
.Tile Attributes
[width="100%",cols="3,^2,^2,^2,10",options="header"]
|=========================================================
|Name | Type |Default |Required |Description
...
| exclusive		| boolean		 |					 | Configures whether or not the first truthy condition should be exclusive. If true, then only the first truthy condition will be executed. If false then all truthy conditions will be executed. the default value is true.
|=========================================================
...
In this example, _status_ is the field and _statusReason_ is the dependent field. We set _statusReason_ to contain the defaults ["A1", "B1"] initially and conditionally define those values when _status_'s state is "A" or "B".

When the state of _status_ is "A", then the Values for _statusReason_ will be ["A1"]. Similarly when the state of _status_ is "B", then the Values for _statusReason_ will be ["B1"].
...
==== ValuesConditionals
@ActivateConditionals is a collection of ValuesConditional calls. 
...
In this example, we have two dependent fields: _statusReason_ and _statusReason2_. Note that nothing has changed for the _statusReason_ field from the previous example, but we have set a @ValuesConditional for the dependent field _statusReason2_ that when the state of _status_ is "A", the Values of _statusReason2_ will be ["A1"].
