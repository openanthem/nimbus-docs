...
.@Min
* When used in conjunction with **@CheckBoxGroup**, **@Min** will require the given number _value_ of checkboxes to be selected.

.@Max
* When used in conjunction with **@CheckBoxGroup**, **@Max** will limit the given number _value_ of checkboxes that are able to be selected.
...
* **Attribute Level**: Activation and deactivation at attribute level based on certain conditions can be handled using @ActivateConditional annotation. Please refer to the link:Documentation.html#_activateconditional[ActivationConditional documentation] for more information.
