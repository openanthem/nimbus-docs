...
As you can see, when you click on addButton, a new Car (nested entity) will be created. There is also a List that points to the nested entity, hence it will
display a list of cars that are created. The Section_ConvertedNestedEntity class has an edit button that will take you to the appropriate page, 
and also a variable vm_attached_convertedList, that points to car_name i.e. name of the car.
