...
|targetPath|String | | Path of param to activate when condition is satisfied relative to param on which this annotation is declared
...
@ActivateConditional(when="state != null && (state.?[#this=='Saturday'] != new String[]{} && state.?[#this=='Sunday'] != new String[]{})",targetPath="/../../../primeDeliverySection")
